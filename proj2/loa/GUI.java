...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("So You've Made a Mistake->Undo", this::undo);
        addMenuButton("Set Players->Black->AI", this::blackAI);
        addMenuButton("Set Players->Black->Human", this::blackHuman);
        addMenuButton("Set Players->White->AI", this::whiteAI);
        addMenuButton("Set Players->White->Human", this::whiteHuman);
    ...
    /** Undoes previous move of player. */
    ...
    /** Undoes previous move of player. */
    private void blackHuman(String dummy) {
    ...
    /** Undoes previous move of player. */
    private void whiteHuman(String dummy) {
